import * as Mad from '@/plugins/mad-parallax'
...
describe('Mad Parallax plugin', () => {
  ...
  describe('Parallax two columns', () => {
    beforeEach(() => {
      jest.spyOn(elem, 'getBoundingClientRect').mockImplementation(() => ({ bottom: 20, top: 10, height: 30 }))
  ...
  describe('Parallax custom move with move pixels', () => {
    beforeEach(() => {
      jest.spyOn(elem, 'getBoundingClientRect').mockImplementation(() => ({ bottom: 20, top: 0, height: 30 }))
    })
