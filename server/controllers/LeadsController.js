...
const { createLead, createEbookLead, createSubscriberLead } = require('../services/LeadsService')
...
async function create(req, res) {
  ...
  } else if (req.body.type === 'subscribe-form') {
    response = await createSubscriberLead(body)
  } else {
