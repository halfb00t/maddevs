...
export const _Description = () => ({
  ...
  data() {
    return {
      mock: {"variation":"description","name":"Description","slice_type":"start_screen","items":[],"primary":{"title":"transition web-enabled solutions","subtitle":"monetize bricks-and-clicks bandwidth"},"id":"_Description"}
    }
  },
  template: '<SliceZone :slices="[mock]" :resolver="resolve" />'
})
